...
const { createPayroll, getAllPayrolls , pendingPayroll, approvePayroll} = usePayrollStore();
...
<template>
  <HeadFinanceLayout>
    ...
    <div
      class="overflow-hidden rounded-xl mt-8 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]"
    >
