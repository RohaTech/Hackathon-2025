          ...
          <form @submit.prevent="submitAddEmployee">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  v-model="newEmployee.employement_type"
                  class="w-full border rounded px-3 py-2"
                >
              ...
              <div class="">
                ...
                <input
                  v-model="newEmployee.account_number"
                  type="text"
                  required
                  class="w-full border rounded px-3 py-2"
                />
            ...
            >
              ...
              <button
                type="submit"
                class="flex w-full justify-center rounded-lg border border-[#0a5098] bg-[#121fb5] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#0a1698] sm:w-auto"
              >
                Submit
              </button>
            </div>
